...
const WomenClothingComponent = () => {
    const products = useSelector(products => products.allProducts.products.filter(product => product.category === "women's clothing"))
    ...
    return (
        <div className='container align-items-center justify-content-center d-flex'>
            <div className='mt-5 d-flex justify-content-around row'>
                <h1 className='brand-name'>Women's Clothing</h1>

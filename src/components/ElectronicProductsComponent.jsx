...
const ElectronicProductsComponent = () => {
    const products = useSelector(products => products.allProducts.products.filter(product => product.category === "electronics"))
    ...
    return (
        <div className='container align-items-center justify-content-center d-flex'>
            <div className='mt-5 d-flex justify-content-around row'>
                <h1 className='brand-name'>Electronic Products</h1>
...
export default ElectronicProductsComponent